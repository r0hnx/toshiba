...
const Aside = () => {
    return (
        <Card className="w-full h-full p-6 flex justify-between flex-col">
            <div className="top">
                <div className="flex items-center space-x-2 mb-6">
                    <CitrusIcon className="text-2xl" color="orange"/>
                    <span className="font-bold text-2xl">OrangeFarm</span>
                </div>
                <div className="flex items-center rounded-md bg-gray-200 p-2 mb-4">
                    <MicroscopeIcon className="text-gray-500" />
                    <Input className="bg-transparent ml-2 w-full" placeholder="Search" type="search" />
                </div>
                <nav className="flex flex-col space-y-1">
                    <a className="flex items-center space-x-2 text-gray-700 py-2" href="#">
                        <LayoutDashboardIcon className="text-gray-500" />
                        <span>Dashboard</span>
                    </a>
                    <a className="flex items-center space-x-2 text-gray-700 py-2" href="#">
                        <UsersIcon className="text-gray-500" />
                        <span>Customers</span>
                        <ChevronDownIcon className="text-gray-500 ml-auto" />
                    </a>
                    <a className="flex items-center space-x-2 text-gray-700 py-2" href="#">
            ...
            <div className="bottom">
                <div className="mt-auto">
                    <div className="flex items-center space-x-2 my-4">
                        <Avatar>
                            <AvatarImage alt="Gustavo Xavier" src="/placeholder.svg?height=40&width=40" />
                            <AvatarFallback>CN</AvatarFallback>
                        </Avatar>
                        <div>
                            <div className="font-bold">Gustavo Xavier</div>
